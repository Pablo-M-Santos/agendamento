...
<template>
  <div class="min-h-screen bg-[#1B1B1B] text-white">
    <header class="p-6 flex items-center gap-4 border-b border-white/5">
      <button class="p-2 hover:bg-white/5 rounded-full transition-colors" @click="voltar">
        <svg
    ...
    <main class="px-6 py-10">
      <section
        class="flex flex-col items-center p-8 bg-[#1B1B1B] rounded-[3rem] border border-white/5 shadow-2xl"
      >
        <div
          class="w-24 h-24 rounded-full border-4 border-[#FA4805] flex items-center justify-center bg-[#020618] overflow-hidden mb-6"
        >
