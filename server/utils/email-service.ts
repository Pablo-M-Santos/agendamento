...
const VERIFICATION_EMAIL_SUBJECT = 'Confirme seu e-mail — Agendamento'
const FROM_NAME = 'Agendamento'

function getVerificationEmailHtml(verificationLink: string, appUrl: string): string {
  return `
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
